...
public class VideoStoreSystem {
	...
	public static void calculateLateFees(String[] name, int[] daysCustomerHadMovie, int[] rentalCode, double[] lateFee, boolean[] late) {
	...
	public static void sortByCustomerId(String[] name, int[] customerId, int[] movieId, int[] rentalCode,  int[] daysCustomerHadMovie, boolean[] late,double[] lateFee) {
		...
		while (swapped) {
			...
			for (int i = 0; i < customerId.length - 1; i++) {
				...
				if (customerId[i] > customerId[i + 1]) {
					...
					swap(i, name, customerId, movieId, rentalCode, daysCustomerHadMovie, late, lateFee);
	...
	public static void swap(int i, String[] name, int[] customerId, int[] movieId,  int[] rentalCode,  int[] daysCustomerHadMovie, boolean[] late,double[] lateFee) {
