...
public class SubstitutionCipherWithNonsense {
	...
	public static String encrypt(String key, String message) {//charKey is the key as a char, which will be converted to an integer.
		int nonsenseKey;
		int shiftKey = key.split(",");
		...
		for (int i = 0; i < message.length(); i++) {
			...
			result[i] += (char) ascii + shiftKey;//shift the character.
